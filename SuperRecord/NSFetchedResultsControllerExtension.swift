...
public extension NSFetchedResultsController {
    ...
    */
    ...
    class func superFetchedResultsController(entityName: String!, sectionNameKeyPath: String?, sortDescriptors: [AnyObject]?, predicate: NSPredicate?, tableView: UITableView!, context: NSManagedObjectContext!, extraDelegate: APXFetchedResultsControllerDelegate?) -> NSFetchedResultsController {
